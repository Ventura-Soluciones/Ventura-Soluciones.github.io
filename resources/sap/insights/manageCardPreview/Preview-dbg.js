...
sap.ui.define([
    ...
    "../utils/InsightsUtils"
], function(Control, SimpleForm, Input, Label, Title, VBox, Page,
    FlexBox, ScrollContainer, Toolbar, OverflowToolbar, ToolbarSpacer, HBox, Card, Panel, Button, DeviceType, Transformations, Device, MessageStrip, AppConstants, SimpleFormLayout, InsightsUtils) {
