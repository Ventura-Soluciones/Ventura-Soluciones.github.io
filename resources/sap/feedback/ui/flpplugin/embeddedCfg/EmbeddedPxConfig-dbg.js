...
sap.ui.define([], function () {
  ...
  var EmbeddedPxConfig = /*#__PURE__*/function () {
    function EmbeddedPxConfig() {
      _classCallCheck(this, EmbeddedPxConfig);
    }
    return _createClass(EmbeddedPxConfig, null, [{
      key: "pushConfig",
      value: function pushConfig() {
        var pushConfig = {
          appPush: {
            configs: [{
              areaId: 'POC',
  ...
  return EmbeddedPxConfig;
});
//# sourceMappingURL=EmbeddedPxConfig-dbg.js.map
