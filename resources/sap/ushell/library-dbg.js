...
sap.ui.define([
    ...
    const oUshellLibrary = Library.init({
        ...
        types: [
            ...
            "sap.ushell.appIntegration.contracts.StatefulType",
    ...
    oUshellLibrary.appIntegration = oUshellLibrary.appIntegration || {};
    oUshellLibrary.appIntegration.contracts = oUshellLibrary.appIntegration.contracts || {};
     ...
     * @private
     */
    oUshellLibrary.appIntegration.contracts.StatefulType = {
        /**
         * The iframe did not respond and is therefore not supported.
        ...
        /**
         * Contract v1 frame. It will be reused.
         * This indicates that the iframe is either in use or in the (keep alive) pool.
         * Only applies to WebGUI.
         *
         * @since 1.134.0
         * @private
         */
        ...
        /**
         * Contract v2 frame. It will be reused.
         * This indicates that the iframe is either in use or in the (keep alive) pool.
         * The appruntime uses only this type, even for keep alive.
         *
         * @since 1.134.0
         * @private
         */
    ...
    /**
     * Enumeration of possible sates for the NavigationBarMenu.
     *
     * @enum {string}
     * @private
     * @since 1.134.0
     */
    oUshellLibrary.NavigationBarMenuState = {

        /**
         * Used when the NavigationBarMenu should be a popover.
         * @private
         */
        Button: "Button",

        /**
         * Used when the NavigationBarMenu should be in the SideNavigation.
         * @private
         */
        Menu: "Menu"
    };
    ...
    /**
     * @name sap.ushell.renderer.INavContainerPage
     * @interface
     * @since 1.135.0
     * @private
     */
    ...
    /**
     * @name sap.ushell.renderer.INavContainerPage.setVisibility
     * @function
     * @since 1.135.0
     * @private
     */
