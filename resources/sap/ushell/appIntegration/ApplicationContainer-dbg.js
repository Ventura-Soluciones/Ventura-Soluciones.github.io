...
sap.ui.define([
    ...
    const ApplicationContainer = Control.extend("sap.ushell.appIntegration.ApplicationContainer", /** @lends sap.ushell.appIntegration.ApplicationContainer.prototype */ {
        metadata: {
            ...
            properties: {
                ...
                // todo: [FLPCOREANDUX-10024] rework this
            ...
            events: {
                 ...
                 */
                applicationConfiguration: { // todo: [FLPCOREANDUX-10024] make this event used consistently
                    parameters: {
                        /**
    ...
    ApplicationContainer.setHandleMessageEvent = function (fnHandleMessageEvent) {
        ApplicationContainer.handleMessageEvent = fnHandleMessageEvent;
     ...
     * @param {string[]} [aCapabilitiesToRemove] The capabilities to remove.
     * @returns {this} this instance for method chaining
     *
     * @since 1.130.0
     * @private
