...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.adapters.cdm.Settings.UserLanguageAndRegion.UserLanguageAndRegion", {
        onInit: function () {
            ...
            var { sTimeFormat, sExampleDate, sDecimalFormat, sWorkWeek, sTimeZone } = this._getParsedLocaleProperties(oLocale);
        ...
        onSave: function (fnUpdateUserPreferences) {
            var oUser = this.oUser,
                ...
                bUpdateLanguage = oModelData.languageList && oModelData.languageList.length > 0 && bLanguageChanged;
            ...
            if (bUpdateLanguage) {
                ...
                return fnUpdateUserPreferences()
                    ...
                    .catch(function (errorMessage) {
                        Log.debug("[000] onSave:catch:errorMessage", errorMessage, "UserLanguageAndRegion.controller");
        ...
        _updateTextFields: function (language) {
            ...
            var oLocale = new Locale(language);
        ...
        _getParsedLocaleProperties: function (oLocale) {
            ...
            var sDecimalPattern = oLocaleData.getDecimalPattern();

            var oNumberFormat = NumberFormat.getInstance({
