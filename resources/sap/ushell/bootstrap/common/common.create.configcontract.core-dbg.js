...
sap.ui.define([
    ...
    function createConfigContract (oMergedSapUshellConfig) {
        ...
        function getEnableBackGroundShapes () {
            const sPath = "renderers/fiori2/componentData/config/enableBackGroundShapes";
            let bEnableShapes = !!getValueFromConfig(oGetConfigValueMemory, sPath);
            if (bEnableShapes) {
        ...
        const oConfigDefinition = {
            core: { // the unified shell core
                ...
                menu: { // Menu Bar
                    ...
                    enabled: (
                        getConfigValue("ushell/spaces/enabled", false) &&
                        getConfigValue("ushell/menu/enabled") !== false &&
                        !getSideNavigationEnabled()) ||
                        getConfigValue("ushell/menu/enabled", false),
                    personalization: {
