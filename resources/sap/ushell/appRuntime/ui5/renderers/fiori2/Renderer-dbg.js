...
sap.ui.define([
    ...
    function RendererProxy () {
        ...
        this.showHeaderItem = function (aIds/*, bCurrentState, aStates*/) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.showHeaderItem", {
                aIds: aIds,
                bCurrentState: true,
                aStates: ""
            });
        ...
        this.showHeaderEndItem = function (aIds/*, bCurrentState, aStates*/) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.showHeaderEndItem", {
                aIds: aIds,
                bCurrentState: true,
                aStates: ""
            });
        ...
        this.hideHeaderItem = function (aIds/*, bCurrentState, aStates*/) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.hideHeaderItem", {
                aIds: aIds,
                bCurrentState: true,
                aStates: ""
            });
        ...
        this.hideHeaderEndItem = function (aIds/*, bCurrentState, aStates*/) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.hideHeaderEndItem", {
                aIds: aIds,
                bCurrentState: true,
                aStates: ""
            });
        ...
        this._addHeaderItem = function (sAPI, oControlProperties, bIsVisible/*, bCurrentState, aStates*/) {
            ...
            return AppRuntimeService.postMessageToFLP(sAPI, {
        ...
        this.setHeaderVisibility = function (bVisible, bCurrentState, aStates) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.setHeaderVisibility", {
                bVisible: bVisible,
        ...
        this.createShellHeadItem = function (params) {
            ...
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.createShellHeadItem", {
                params: params
            });
        };

        this.showActionButton = function (aIds, bCurrentState, aStates) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.showActionButton", {
                aIds: aIds,
                bCurrentState: bCurrentState,
                aStates: aStates
            });
        ...
        this.hideActionButton = function (aIds, bCurrentState, aStates) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.hideActionButton", {
                aIds: aIds,
                bCurrentState: bCurrentState,
                aStates: aStates
            });
        ...
        this.addUserAction = function (oParameters) {
            ...
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.addUserAction", {
        ...
        this.updateHeaderItem = function (sId, oControlProperties) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.updateHeaderItem", {
                sId: sId,
        ...
        this.destroyButton = function (aIds) {
            AppRuntimeService.postMessageToFLP("sap.ushell.services.Renderer.destroyButton", {
                aIds: aIds
            });
        };
    }
