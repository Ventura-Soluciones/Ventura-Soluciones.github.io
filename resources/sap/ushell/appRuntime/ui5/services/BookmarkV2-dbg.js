    ...
    function BookmarkV2Proxy (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.addBookmark = function (oParameters, vContainer) {
            var fnAddBookmark = function () {
                return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.addBookmarkUI5", {
        ...
        this.getShellGroupIDs = function () {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.getShellGroupIDs");
        };
        ...
        this.countBookmarks = function (sUrl) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.countBookmarks", {
                sUrl: sUrl
            });
        };
        ...
        this.deleteBookmarks = function (sUrl) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.deleteBookmarks", {
                sUrl: sUrl
            });
        };
        ...
        this.updateBookmarks = function (sUrl, oParameters) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.updateBookmarks", {
                sUrl: sUrl,
                oParameters: oParameters
            });
        };
        ...
        this.getContentNodes = function () {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.BookmarkV2.getContentNodes");
        };
