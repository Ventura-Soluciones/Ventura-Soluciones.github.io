    ...
    function CrossApplicationNavigationProxy (oContainerInterface, sParameters, oServiceConf) {
        ...
        this.backToPreviousApp = function () {
            ...
            if (AppRuntimeContext.checkDataLossAndContinue()) {
                return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.backToPreviousApp");
            }
        };
        ...
        this.expandCompactHash = function (sHashFragment) {
            ...
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.expandCompactHash", {
        ...
        this.getDistinctSemanticObjects = function () {
            ...
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.getDistinctSemanticObjects");
        };
        ...
        this.getPrimaryIntent = function (sSemanticObject, mParameters) {
            //not ready for scube
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.getPrimaryIntent", {
        ...
        this.getSemanticObjectLinks = function (sSemanticObject, mParameters, bIgnoreFormFactor, oComponent,
            ...
            //not ready for scube
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.getSemanticObjectLinks", {
                sSemanticObject: sSemanticObject,
                mParameters: mParameters,
        ...
        this.historyBack = function (iSteps) {
            //ready for scube
            if (AppRuntimeContext.checkDataLossAndContinue()) {
                AppRuntimeService.postMessageToFLP("sap.ushell.services.CrossApplicationNavigation.historyBack", {
                    iSteps: iSteps
                });
            }
        };
        ...
        this.isIntentSupported = function (aIntents, oComponent) {
            ...
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.isIntentSupported", {
                aIntents: aIntents
            });
        };
        ...
        this.isNavigationSupported = function (aIntents, oComponent, bCheckInOuterShellOnly) {
            var fnCheckInShell = function (aIntentsTmp) {
                return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.isNavigationSupported", {
        ...
        this.getAppState = function (oAppComponent, sAppStateKey) {
            ...
            AppRuntimeService.postMessageToFLP("sap.ushell.services.CrossApplicationNavigation.getAppState", {
                sAppStateKey: sAppStateKey
        ...
        this.resolveIntent = function (sHashFragment) {
            ...
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.resolveIntent", {
                sHashFragment: sHashFragment
            });
        };
        ...
        this.hrefForExternalAsync = function (oArgs) {
            //not ready for scube
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.hrefForExternal", {
                oArgs: oArgs
            });
        };
        ...
        this.hrefForAppSpecificHashAsync = function (sAppHash) {
            //not ready for scube
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.CrossApplicationNavigation.hrefForAppSpecificHash", {
                sAppHash: sAppHash
            });
        };
