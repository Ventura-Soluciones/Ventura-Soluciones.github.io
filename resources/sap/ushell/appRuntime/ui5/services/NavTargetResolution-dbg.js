...
sap.ui.define([
    ...
    function NavTargetResolutionProxy (oAdapter, oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.getDistinctSemanticObjects = function () {
            ...
            aPromises.push(AppRuntimeService.postMessageToFLP("sap.ushell.services.NavTargetResolution.getDistinctSemanticObjects"));
        ...
        this.expandCompactHash = function (sHashFragment) {
            if (sHashFragment && sHashFragment.indexOf("sap-intent-param") > 0) {
                return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.NavTargetResolution.expandCompactHash", {
        ...
        this.resolveHashFragment = function (sHashFragment) {
            if (AppRuntimeContext.getIsScube()) {
                ...
                this.resolveHashFragmentLocal(sHashFragment)
                    ...
                    .fail(function () {
                        return AppRuntimeService.postMessageToFLP("sap.ushell.services.NavTargetResolution.resolveHashFragment", {
                            sHashFragment: sHashFragment
                        }).then(oDeferred.resolve, oDeferred.reject);
                    });
                return oDeferred.promise();
            }
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.NavTargetResolution.resolveHashFragment", {
                sHashFragment: sHashFragment
            });
        };
        ...
        this.isIntentSupported = function (aIntents) {
            ...
            aPromises.push(AppRuntimeService.postMessageToFLP("sap.ushell.services.NavTargetResolution.isIntentSupported", {
                aIntents: aIntents
            }));
            Promise.allSettled(aPromises).then(function (aResults) {
