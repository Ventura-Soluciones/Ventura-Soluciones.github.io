    ...
    function BookmarkProxy (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.addBookmark = function (oParameters, vContainer) {
            ...
            var fnAddBookmark = function () {
                return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.addBookmarkUI5", {
        ...
        this.getShellGroupIDs = function () {
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.getShellGroupIDs");
        };
        ...
        this.addCatalogTileToGroup = function (sCatalogTileId, sGroupId, oCatalogData) {
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.addCatalogTileToGroup", {
        ...
        this.countBookmarks = function (sUrl) {
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.countBookmarks", {
                sUrl: sUrl
            });
        };
        ...
        this.deleteBookmarks = function (sUrl) {
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.deleteBookmarks", {
                sUrl: sUrl
            });
        };
        ...
        this.updateBookmarks = function (sUrl, oParameters) {
            return AppRuntimeService.sendMessageToOuterShell("sap.ushell.services.Bookmark.updateBookmarks", {
                sUrl: sUrl,
                oParameters: oParameters
            });
        };
        ...
        this.addCustomBookmark = function (sVizType, oConfig, vContentNodes) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Bookmark.addCustomBookmark", {
                sVizType: sVizType,
                oConfig: oConfig,
        ...
        this.countCustomBookmarks = function (oIdentifier) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Bookmark.countCustomBookmarks", {
        ...
        this.updateCustomBookmarks = function (oIdentifier, oConfig) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Bookmark.updateCustomBookmarks", {
                oIdentifier: oIdentifier,
                oConfig: oConfig
            });
        };
        ...
        this.deleteCustomBookmarks = function (oIdentifier) {
            return AppRuntimeService.postMessageToFLP("sap.ushell.services.Bookmark.deleteCustomBookmarks", {
                oIdentifier: oIdentifier
            });
        };
