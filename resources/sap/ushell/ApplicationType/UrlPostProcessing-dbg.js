...
sap.ui.define([
     ...
     * @param {boolean} [bForFramelessWindow=false] whether the url is for a frameless window
     ...
     * @private
     */
    UrlPostProcessing.processUrl = function (sUrl, sApplicationType, bForFramelessWindow, oApplicationContainer) {
        ...
        sUrl = this._processUrl(sUrl, sApplicationType, sTargetNavigationMode, bIsReusableContainer, bForFramelessWindow, sUi5Version);
     ...
     * @private
     */
    UrlPostProcessing._processUrl = function (sUrl, sApplicationType, sTargetNavigationMode, bReuseSession, bForFramelessWindow, sUi5Version) {
