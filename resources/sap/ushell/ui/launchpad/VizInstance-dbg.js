...
sap.ui.define([
    ...
    /**
     * Returns the Promise from the load method which resolves when the loading is completed.
     *
     * This method is used to wait for the loading of the content to be completed when the loading was already started.
     *
     * @returns {Promise} Resolves when loading is completed
     *
     * @since 1.136.0
     * @private
     */
    VizInstance.prototype.loaded = function () {
        // Needs to be implemented in the child classes.
        return this._pLoad;
    };
