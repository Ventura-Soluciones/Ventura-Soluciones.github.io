    ...
    return function (sId, mSettings) {
        ...
        oHost.attachCardStateChanged(async (oEvent) => {
            ...
            if (oMessage?.type === "Error" && oHost._mUnresolvedDestinations.has(oCard)) {
                oMessage.illustrationType = IllustratedMessageType.UnableToLoad;
                oMessage.illustrationSize = IllustratedMessageSize.ExtraSmall;
         ...
         *
         * @param {sap.ui.base.Event} oEvent Event triggered by the card
