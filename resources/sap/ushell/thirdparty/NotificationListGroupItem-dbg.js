sap.ui.define(['sap/ushell/thirdparty/webcomponents-base', 'sap/ushell/thirdparty/webcomponents', 'sap/ushell/thirdparty/webcomponents-fiori', 'sap/ushell/thirdparty/event-strict', 'sap/ushell/thirdparty/i18n-defaults', 'sap/ushell/thirdparty/NotificationListItemBase', 'sap/ushell/thirdparty/Icons', 'sap/ushell/thirdparty/i18n-defaults2', 'sap/ushell/thirdparty/Icon', 'sap/ushell/thirdparty/List', 'sap/ushell/thirdparty/parameters-bundle.css', 'sap/ushell/thirdparty/BusyIndicator', 'sap/ushell/thirdparty/Label', 'sap/ushell/thirdparty/toLowercaseEnumValue'], (function (webcomponentsBase, webcomponents, webcomponentsFiori, eventStrict, i18nDefaults, NotificationListItemBase, Icons, i18nDefaults$1, Icon, List, parametersBundle_css, BusyIndicator, Label, toLowercaseEnumValue) { 'use strict';
	...
	function NotificationListItemTemplate() {
	    return (i18nDefaults.jsxs("li", { class: "ui5-nli-group-root ui5-nli-focusable", onFocusIn: this._onfocusin, onKeyDown: this._onkeydown, tabindex: this.forcedTabIndex ? parseInt(this.forcedTabIndex) : undefined, "aria-labelledby": this.ariaLabelledBy, "aria-description": this.accInvisibleText, "aria-level": 1, children: [this.loading && (i18nDefaults.jsx("span", { id: `${this._id}-loading`, class: "ui5-hidden-text", children: this.loadingText })), i18nDefaults.jsxs("div", { class: "ui5-nli-group-content-wrapper", children: [i18nDefaults.jsxs("div", { class: {
	                            "ui5-nli-group-header": true,
	                            "ui5-nli-group-header-expanded": this._expanded,
	                        }, onClick: this._onHeaderToggleClick, onKeyDown: this._onkeydown, role: "button", "aria-expanded": this._expanded, "aria-controls": `${this._id}-notificationsList`, title: this.toggleIconAccessibleName, children: [i18nDefaults.jsx(Icon.Icon, { name: this.groupCollapsedIcon, class: "ui5-nli-group-toggle-icon", mode: "Decorative" }), i18nDefaults.jsx("div", { id: `${this._id}-title-text`, class: "ui5-nli-group-title-text", part: "title-text", role: "heading", "aria-level": 2, children: this.titleText }), i18nDefaults.jsx("div", { class: "ui5-nli-group-divider" })] }), i18nDefaults.jsx(NotificationListGroupList$1, { id: `${this._id}-notificationsList`, class: "ui5-nli-group-items", accessibleNameRef: `${this._id}-title-text`, growing: this.growing, loading: this.loading, loadingDelay: this.loadingDelay, onLoadMore: this._onLoadMore, children: i18nDefaults.jsx("slot", {}) })] })] }));
	}
...
`;
	...
	let NotificationListGroupItem = NotificationListGroupItem_1 = class NotificationListGroupItem extends NotificationListItemBase.NotificationListItemBase {
	    ...
	    get toggleIconAccessibleName() {
	        return NotificationListGroupItem_1.i18nFioriBundle.getText(i18nDefaults$1.NOTIFICATION_LIST_GROUP_ITEM_TOGGLE_ICON_COLLAPSE_TITLE);
	    }
	    ...
	    get expandText() {
	        if (this.collapsed) {
	            return NotificationListGroupItem_1.i18nFioriBundle.getText(i18nDefaults$1.NOTIFICATION_LIST_GROUP_COLLAPSED);
	        }
	        return NotificationListGroupItem_1.i18nFioriBundle.getText(i18nDefaults$1.NOTIFICATION_LIST_GROUP_EXPANDED);
	    }
	    get groupText() {
	        return NotificationListGroupItem_1.i18nFioriBundle.getText(i18nDefaults$1.NOTIFICATION_LIST_GROUP_ITEM_TXT);
	    }
	    get ariaLabelledBy() {
	        const id = this._id;
	        if (this.loading) {
