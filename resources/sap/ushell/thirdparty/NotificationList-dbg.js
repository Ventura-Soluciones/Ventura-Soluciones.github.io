sap.ui.define(['sap/ushell/thirdparty/webcomponents-base', 'sap/ushell/thirdparty/webcomponents', 'sap/ushell/thirdparty/webcomponents-fiori', 'sap/ushell/thirdparty/i18n-defaults', 'sap/ushell/thirdparty/event-strict', 'sap/ushell/thirdparty/List', 'sap/ushell/thirdparty/NotificationListGroupItem', 'sap/ushell/thirdparty/Icons', 'sap/ushell/thirdparty/parameters-bundle.css', 'sap/ushell/thirdparty/i18n-defaults2', 'sap/ushell/thirdparty/toLowercaseEnumValue', 'sap/ushell/thirdparty/BusyIndicator', 'sap/ushell/thirdparty/Label', 'sap/ushell/thirdparty/NotificationListItemBase', 'sap/ushell/thirdparty/Icon'], (function (webcomponentsBase, webcomponents, webcomponentsFiori, i18nDefaults, eventStrict, List, NotificationListGroupItem, Icons, parametersBundle_css, i18nDefaults$1, toLowercaseEnumValue, BusyIndicator, Label, NotificationListItemBase, Icon) { 'use strict';
    ...
    function NotificationListTemplate() {
        return (i18nDefaults.jsx(NotificationListInternal$1, { accessibleName: this._accessibleName, noDataText: this.noDataText, onItemClick: this._onItemClick, onItemClose: this._onItemClose, onItemToggle: this._onItemToggle, onLoadMore: this._onLoadMore, children: i18nDefaults.jsx("slot", {}) }));
    }
...
`;
    ...
    let NotificationList = NotificationList_1 = class NotificationList extends webcomponentsBase.b {
        get _accessibleName() {
            return NotificationList_1.i18nFioriBundle.getText(i18nDefaults$1.NOTIFICATION_LIST_ACCESSIBLE_NAME);
        }
        getEnabledItems() {
