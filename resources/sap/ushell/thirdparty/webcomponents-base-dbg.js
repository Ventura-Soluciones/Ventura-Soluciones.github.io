sap.ui.define(['exports', 'sap/ushell/thirdparty/Icons'], (function (exports, Icons) { 'use strict';
  ...
  let n$b;Icons.i$1(()=>{n$b=void 0;});const d$3=()=>(n$b===void 0&&(n$b=Icons.C()),n$b),m$5=o=>{Object.values(Icons.u$1).includes(o)&&(n$b=o);};

  var s$a=(i=>(i.Gregorian="Gregorian",i.Islamic="Islamic",i.Japanese="Japanese",i.Buddhist="Buddhist",i.Persian="Persian",i))(s$a||{});

  let n$a;Icons.i$1(()=>{n$a=void 0;});const i$7=()=>(n$a===void 0&&(n$a=Icons.I()),n$a&&n$a in s$a?n$a:s$a.Gregorian);
  ...
  let e$6;Icons.i$1(()=>{e$6=void 0;});const n$9=()=>(e$6===void 0&&(e$6=Icons.M()),e$6.firstDayOfWeek),i$6=Icons.n$1("LegacyDateFormats"),m$4=i$6?a$5.getLegacyDateCalendarCustomizing:()=>[];

  const c$6=["value-changed","click"];let e$5;Icons.i$1(()=>{e$5=void 0;});const s$9=t=>c$6.includes(t),l$6=t=>{const n=o$6();return !(typeof n!="boolean"&&n.events&&n.events.includes&&n.events.includes(t))},o$6=()=>(e$5===void 0&&(e$5=Icons.U()),e$5),f$4=t=>{e$5=t;},a$4=t=>{const n=o$6();return s$9(t)?false:n===true?true:!l$6(t)};
  ...
  const y$2={TAB:9,ENTER:13,SHIFT:16,ESCAPE:27,SPACE:32,PAGE_UP:33,PAGE_DOWN:34,END:35,HOME:36,ARROW_LEFT:37,ARROW_UP:38,ARROW_RIGHT:39,ARROW_DOWN:40,DELETE:46,NUMPAD_PLUS:107,NUMPAD_MINUS:109,F10:121,PLUS:187,MINUS:219},b$4=o=>(o.key?o.key==="Enter":o.keyCode===y$2.ENTER)&&!a$3(o),d$1=o=>(o.key?o.key==="Enter":o.keyCode===y$2.ENTER)&&e$4(o,false,false,true),f$3=o=>e$4(o,true,false,false),i$5=o=>(o.key?o.key==="Spacebar"||o.key===" ":o.keyCode===y$2.SPACE)&&!a$3(o),K=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$2.ARROW_LEFT)&&!a$3(o),c$5=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$2.ARROW_RIGHT)&&!a$3(o),D$1=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$2.ARROW_UP)&&!a$3(o),P=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$2.ARROW_DOWN)&&!a$3(o),O$2=o=>(o.key?o.key==="ArrowUp"||o.key==="Up":o.keyCode===y$2.ARROW_UP)&&e$4(o,false,false,true),u$2=o=>(o.key?o.key==="ArrowDown"||o.key==="Down":o.keyCode===y$2.ARROW_DOWN)&&e$4(o,false,false,true),w=o=>(o.key?o.key==="ArrowLeft"||o.key==="Left":o.keyCode===y$2.ARROW_LEFT)&&e$4(o,false,false,true),T=o=>(o.key?o.key==="ArrowRight"||o.key==="Right":o.keyCode===y$2.ARROW_RIGHT)&&e$4(o,false,false,true),F=o=>(o.key?o.key==="Home":o.keyCode===y$2.HOME)&&!a$3(o),W=o=>(o.key?o.key==="End":o.keyCode===y$2.END)&&!a$3(o),H=o=>(o.key?o.key==="Escape"||o.key==="Esc":o.keyCode===y$2.ESCAPE)&&!a$3(o),B=o=>(o.key?o.key==="Tab":o.keyCode===y$2.TAB)&&!a$3(o),m$2=o=>(o.key?o.key==="Tab":o.keyCode===y$2.TAB)&&e$4(o,false,false,true),V=o=>(o.key?o.key==="Delete":o.keyCode===y$2.DELETE)&&!a$3(o),Y=o=>(o.key?o.key==="PageUp":o.keyCode===y$2.PAGE_UP)&&!a$3(o),Z=o=>(o.key?o.key==="PageDown":o.keyCode===y$2.PAGE_DOWN)&&!a$3(o),yo=o=>(o.key?o.key==="+":o.keyCode===y$2.PLUS)||o.keyCode===y$2.NUMPAD_PLUS&&!a$3(o),eo=o=>(o.key?o.key==="-":o.keyCode===y$2.MINUS)||o.keyCode===y$2.NUMPAD_MINUS&&!a$3(o),so=o=>o.key==="F2"&&!a$3(o),ro=o=>(o.key?o.key==="F10":o.keyCode===y$2.F10)&&e$4(o,false,false,true),io=o=>o.key==="Shift"||o.keyCode===y$2.SHIFT,a$3=o=>o.shiftKey||o.altKey||k(o),k=o=>!!(o.metaKey||o.ctrlKey),e$4=(o,r,l,E)=>o.shiftKey===E&&o.altKey===l&&k(o)===r;
  ...
  var PackageModule = /*#__PURE__*/Object.freeze({
    ...
    getFetchDefaultLanguage: Icons.c$4,
