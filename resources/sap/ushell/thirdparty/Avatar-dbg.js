sap.ui.define(['sap/ushell/thirdparty/webcomponents-base', 'sap/ushell/thirdparty/webcomponents', 'sap/ushell/thirdparty/event-strict', 'sap/ushell/thirdparty/i18n-defaults', 'sap/ushell/thirdparty/Icons', 'sap/ushell/thirdparty/Icon'], (function (webcomponentsBase, webcomponents, eventStrict, i18nDefaults, Icons, Icon) { 'use strict';

    function AvatarTemplate() {
        return (i18nDefaults.jsxs("div", { class: "ui5-avatar-root", tabindex: this.tabindex, "data-sap-focus-ref": true, role: this._role, "aria-haspopup": this._ariaHasPopup, "aria-label": this.accessibleNameText, onKeyUp: this._onkeyup, onKeyDown: this._onkeydown, onClick: this._onclick, children: [this.hasImage ?
                    i18nDefaults.jsx("slot", {})
                    :
                        i18nDefaults.jsxs(i18nDefaults.Fragment, { children: [this.icon && i18nDefaults.jsx(Icon.Icon, { class: "ui5-avatar-icon", name: this.icon, accessibleName: this.accessibleName }), this.initials &&
                                    i18nDefaults.jsxs(i18nDefaults.Fragment, { children: [i18nDefaults.jsx("span", { class: "ui5-avatar-initials ui5-avatar-initials-hidden", children: this.validInitials }), i18nDefaults.jsx(Icon.Icon, { name: this.fallbackIcon, class: "ui5-avatar-icon ui5-avatar-icon-fallback ui5-avatar-fallback-icon-hidden" })] })] }), i18nDefaults.jsx("slot", { name: "badge" })] }));
    }
