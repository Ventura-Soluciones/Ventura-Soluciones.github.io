sap.ui.define(['exports', 'sap/ushell/thirdparty/webcomponents-base', 'sap/ushell/thirdparty/i18n-defaults', 'sap/ushell/thirdparty/toLowercaseEnumValue', 'sap/ushell/thirdparty/event-strict', 'sap/ushell/thirdparty/Icons', 'sap/ushell/thirdparty/BusyIndicator'], (function (exports, webcomponentsBase, i18nDefaults, toLowercaseEnumValue, eventStrict, Icons, BusyIndicator) { 'use strict';
...
`;
     ...
     * @private
     */
    let ListItemGroupHeader = ListItemGroupHeader_1 = class ListItemGroupHeader extends BusyIndicator.ListItemBase {
        constructor() {
            super(...arguments);
    ...
    ListItemGroupHeader = ListItemGroupHeader_1 = __decorate$2([
        webcomponentsBase.m({
            ...
            styles: [BusyIndicator.ListItemBase.styles, ListItemGroupHeaderCss],
        })
    ], ListItemGroupHeader);
...
`;
    ...
    let List = List_1 = class List extends webcomponentsBase.b {
        ...
        _updateAssociatedLabelsTexts() {
            this._associatedDescriptionRefTexts = toLowercaseEnumValue.p(this);
            this._associatedLabelsRefTexts = toLowercaseEnumValue.E(this);
        }
        onEnterDOM() {
            toLowercaseEnumValue.y(this, this._updateAssociatedLabelsTexts.bind(this));
            p.subscribe(this);
            webcomponentsBase.f.register(this.getDomRef(), this._handleResizeCallback);
        }
        onExitDOM() {
            toLowercaseEnumValue.T(this);
        ...
        get ariaLabelTxt() {
            return this._associatedLabelsRefTexts || toLowercaseEnumValue.A(this);
        }
        get ariaDescriptionText() {
            return this._associatedDescriptionRefTexts || toLowercaseEnumValue.L(this) || this._getDescriptionForGroups();
        }
        get scrollContainer() {
