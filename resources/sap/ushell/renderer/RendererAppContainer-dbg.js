...
sap.ui.define([
    ...
    var ComponentLifecycle = coreLibrary.ComponentLifecycle;
     ...
     */
    var RendererAppContainer = Control.extend("sap.ushell.renderer.RendererAppContainer", {
        metadata: {
            properties: {
        ...
        renderer: {
            ...
            render: function (oRenderManager, oControl) {
                ...
                var oChild = oControl.getAggregation("child");
                if (oChild) {
    ...
    RendererAppContainer.prototype.loadChild = function () {
        if (!this._hasValidConfig()) {
            return Promise.reject("The RenderAppContainer does not yet have all of the required properties set, and thus can not be loaded.");
        }

        if (this._getChild()) {
            return Promise.reject("The RenderAppContainer already has a Component loaded. A Component is not allowed to be loaded twice!");
        }
