...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.renderer.Shell", /** @lends sap.ushell.renderer.Shell.prototype */ {
        ...
        onBeforeNavigate: function (oEvent) {
            ...
            const bToHomeAppWrapperView = oToView === oOwnerComponent.byId("homeApp-component-wrapper-container");
            ...
            const bMenuVisible = bToDashboardView || bToPagesView || bToHomeAppWrapperView || bToHomeAppView || bToWorkpagesView || bToSwitcherView;
