...
sap.ui.define([
    ...
    "sap/base/Log"
], function (SearchProvider, SearchServiceProvider, FrequentActivityProvider, RecentSearchProvider, Log) {
    "use strict";
    ...
    return {
        runProviders: function (sQuery) {
            var arrProviders,
                idx;
            if (sQuery !== undefined) {
                arrProviders = [SearchServiceProvider];
            } else {
                arrProviders = [SearchServiceProvider, FrequentActivityProvider, RecentSearchProvider];
            }
