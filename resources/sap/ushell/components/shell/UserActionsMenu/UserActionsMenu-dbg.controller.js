...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.UserActionsMenu.UserActionsMenu", {
        ...
        _toggleUserActionsMenuPopover: async function (bShow) {
            let sFragmentName;
            var pUserMenuItemLoaded = new Promise((resolve) => {
                if (this.getDisplayAvatar()) {
                    sFragmentName = "sap.ushell.components.shell.UserActionsMenu.UserActionsMenu";

                    sap.ui.require(["sap/ushell/thirdparty/ui5/webcomponents-fiori/UserMenuItem"], () => {
                        resolve();
                    });
                } else {
         ...
         * @returns {sap.ushell.thirdparty.ui5.webcomponents-fiori.UserMenuItem} User Menu Item
         */
        userActionsMenuItemFactory: function (sId, oContext) {
            ...
            const UserMenuItem = sap.ui.require("sap/ushell/thirdparty/ui5/webcomponents-fiori/UserMenuItem");
         ...
         *
         * @returns {sap.m.Popover|sap.ushell.thirdparty.ui5.webcomponents-fiori.UserMenuItem} Returns the popover or the web component for chaining
         */
