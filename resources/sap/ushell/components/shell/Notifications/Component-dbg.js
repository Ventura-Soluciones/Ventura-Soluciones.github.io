...
sap.ui.define([
    ...
    var iNotificationsAlertTimeout = 10;
    ...
    return UIComponent.extend("sap.ushell.components.shell.Notifications.Component", {
        ...
        handleNotification: function (oNotification) {
            ...
            if (Config.last("/core/notifications/enabled")) {
                sap.ui.require([
                    "sap/ushell/thirdparty/ui5/webcomponents/Label",
                    "sap/ushell/thirdparty/ui5/webcomponents-fiori/NotificationList",
                    "sap/ushell/thirdparty/ui5/webcomponents-fiori/NotificationListItem"
            ...
            // Use classic notifications popover
                ...
                const iTimeout = setTimeout(function () {
                    this.oRenderer.removeRightFloatingContainerItem(oAlertEntry.getId(), true);
                }.bind(this), iNotificationsAlertTimeout * 1000);
                this._aTimeouts.push(iTimeout);
            }
        },
                    ...
                    this._oNotificationsPopoverPromise = new Promise((resolve, reject) => {
                        this.runAsOwner(() => {
                            XMLView.create({
                                ...
                                oPopover.attachBeforeOpen(oController.getNextPage.bind(oController, true));
