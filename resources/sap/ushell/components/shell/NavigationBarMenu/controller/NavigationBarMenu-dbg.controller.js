...
sap.ui.define([
    ...
    return Controller.extend("sap.ushell.components.shell.NavigationBarMenu.controller.NavigationBarMenu", /** @lends sap.ushell.components.shell.NavigationBarMenu.controller.NavigationBarMenu.prototype */ {
        ...
        rearrangePinnedSpaces: function (oEvent) {
            ...
            var iSourcePinnedSortOrder = oModel.getProperty(oDraggedSpaceContext.getPath()).pinnedSortOrder;
            var oDroppedSpace = oEvent.getParameter("droppedControl");
            var oDroppedSpaceContext = oDroppedSpace.getBindingContext("spaces");
            var iDroppedPinnedSortOrder = oModel.getProperty(oDroppedSpaceContext.getPath()).pinnedSortOrder;
        ...
        onMenuItemSelection: async function (oEvent) {
            ...
            const oModel = this._getModel();
            var oListItemModelEntry = oModel.getProperty(oItemContextPath);
