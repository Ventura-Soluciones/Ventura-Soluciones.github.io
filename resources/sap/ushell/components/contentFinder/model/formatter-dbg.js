...
sap.ui.define([
    ...
    return {
        ...
        formatVisualizationsNoDataIllustratedMessageTitle: function (bTreeItemPressed, sSearchTerm, sNoItemsInCatalogTitle, sOverrideTitle) {
            ...
            return this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("ContentFinder.AppSearch.IllustratedMessage.Tiles.NoData.Title");
        },
        ...
        formatVisualizationsNoDataIllustratedMessageDescription: function (
            ...
            return this.getOwnerComponent().getModel("i18n").getResourceBundle().getText("ContentFinder.AppSearch.IllustratedMessage.Tiles.NoData.Details");
