...
//		oDataLoadedWrapper.attachStateChanged(changeIappState);
		...
		function getCurrentAppState() {
			...
			return {
				version: oUI5VersionInfo.version, // storing creation version of appState to allow better mapping for future structure changes
		...
		function fnParseUrlAndApplyAppState(){
			var oRet = new Promise(function(fnResolve){
				try {
					...
					fnAdaptToAppState({}, {}, sap.fe.navigation.NavType.initial); // Use NavType initial, as this will enforce selection in case auto-binding is true.
					fnResolve();
				}
			});
			return oRet;
