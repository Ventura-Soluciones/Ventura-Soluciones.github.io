...
sap.ui.define([
	 ...
	 * @param {object | object []} nodeRefs Node reference or array of node references that will be highlighted
	 * @private
	 */
	 ...
	 *
	 * @return {boolean} Returns <code>true</code> if view has animations, otherwise <code>false</code>
	 * @private
	 */
	 ...
	 *
	 * @return {sap.ui.vk.AnimationPlayback []} All playbacks in the view
	 * @private
	 */
	 ...
	 *
	 * @param {int} index Index of a playback
	 * @return {sap.ui.vk.AnimationPlayback} Returns animation playback for given index or <code>undefined</code> if index is out of range
	 * @private
	 */
	 ...
	 *
	 * @param {sap.ui.vk.AnimationPlayback} playback Find index of a playback
	 * @return {int} index
	 * @private
	 */
	 ...
	 *
	 * @param {sap.ui.vk.AnimationPlayback} playback Playback to be added
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksAdded</code> will not be fired
	 *
	 * @return {sap.ui.vk.View} return this
	 * @private
	 */
	 ...
	 *
	 * @param {sap.ui.vk.AnimationPlayback} playback Playback to be inserted
	 * @param {int} index Index at which playback will be inserted
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksInserted</code> will not be fired
	 *
	 * @return {sap.ui.vk.View} return this
	 * @private
	 */
	 ...
	 *
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksOrderChanged</code> will not be fired
	 *
	 * @return {boolean} <code>true</code> if re-ordering is successful (playbacks have different start times), false otherwise
	 * @private
	 */
	View.prototype.sortPlaybacks = function(blockPlaybacksChangedEvent) {
	 ...
	 *
	 * @param {int | string | sap.ui.vk.AnimationPlayback} vObject Playback index, playback id or playback object
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksRemoved</code> will not be fired
	 *
	 * @return {sap.ui.vk.View} return this
	 * @private
	 */
	...
	/**
	 * Removes all animation playbacks
	 *
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksRemoved</code> will not be fired
	 *
	 * @return {sap.ui.vk.View} return this
	...
	/**
	 * Swap positions of two playbacks
	 *
	 ...
	 *
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksStartTimeChanged</code> will not be fired
	 *
	 * @return {sap.ui.vk.View} return this
	 * @private
	 */
	 ...
	 *
	 * @param {boolean} reversed If <code>true</code> then playbacks order will be reversed
	 * @param {boolean} blockPlaybacksChangedEvent If <code>true</code> then event <code>playbacksChanged</code> will not be fired
	 * @return {sap.ui.vk.View} return this
	 * @private
	 */
