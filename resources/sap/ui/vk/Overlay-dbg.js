...
sap.ui.define([
	 ...
	 * @since 1.32.0
	 * @deprecated As of version 1.120. This is not in use anymore. Please consider using Redline tool, see {@link sap.ui.vk.RedlineTool}
	 */
	...
	Overlay.prototype._update = function() {
		...
		if (oApp.SAPVB.Actions) {
			var actionArray = this._getActionArray();
			for (var i = 0; i < actionArray.length; i++) {
				oApp.SAPVB.Actions.Set.Action.push(actionArray[i]);
			}
		}
