 ...
 */
sap.ui.define(["sap/base/i18n/Formatting", "sap/base/Log", "sap/fe/navigation/NavigationHandler", "sap/fe/navigation/SelectionVariant", "sap/ui/core/format/DateFormat", "sap/ui/core/format/NumberFormat", "sap/ui/model/odata/v4/ODataModel"], function (Formatting, Log, NavigationHandler, SelectionVariant, DateFormat, NumberFormat, ODataModel) {
  "use strict";
   ...
   */
  const getSituationMessage = function (rawText) {
   ...
   */
  function executeNavigation(oData, ownerComponent) {
   ...
   */
  function fetchNavigationTargetData(instanceId, situationEngineType) {
    try {
  ...
  __exports.getSituationMessage = getSituationMessage;
  __exports.executeNavigation = executeNavigation;
  __exports.fetchNavigationTargetData = fetchNavigationTargetData;
  return __exports;
});
//# sourceMappingURL=SituationUtils-dbg-dbg.js.map
