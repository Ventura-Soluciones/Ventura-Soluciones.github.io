 ...
 */
sap.ui.define(["sap/base/Log", "sap/f/GridContainer", "sap/f/GridContainerSettings", "sap/m/HeaderContainer", "sap/m/IllustratedMessage", "sap/m/IllustratedMessageSize", "sap/m/MessageToast", "sap/m/VBox", "sap/m/library", "sap/ushell/Config", "sap/ushell/Container", "./App", "./BasePanel", "./utils/AppManager", "./utils/DataFormatUtils", "./utils/Device"], function (Log, GridContainer, GridContainerSettings, HeaderContainer, IllustratedMessage, IllustratedMessageSize, MessageToast, VBox, sap_m_library, Config, Container, __App, __BasePanel, __AppManager, ___utils_DataFormatUtils, ___utils_Device) {
  "use strict";
