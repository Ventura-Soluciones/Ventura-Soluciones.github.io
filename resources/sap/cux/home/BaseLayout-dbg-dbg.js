 ...
 */
sap.ui.define(["sap/base/Log", "sap/base/util/deepEqual", "sap/m/library", "sap/m/Page", "sap/ui/core/Element", "sap/ui/core/Lib", "sap/ui/core/routing/HashChanger", "./BaseLayoutRenderer", "./BasePanel", "./library", "./utils/Device"], function (Log, deepEqual, sap_m_library, Page, UI5Element, Lib, HashChanger, __BaseLayoutRenderer, __BasePanel, ___library, ___utils_Device) {
  "use strict";
  ...
  const BaseLayout = Page.extend("sap.cux.home.BaseLayout", {
     ...
     */
    openContentAdditionDialog: function _openContentAdditionDialog() {
      let selectedKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";
