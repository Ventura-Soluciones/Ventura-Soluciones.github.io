            ...
            if (_this2._getSupported()) {
              setTimeout(() => {
                ...
                _this2._submitBatch().then(function () {
                   ...
                   * */
                  const toDosWrapper = _this2._getContent()?.[0];
        ...
        try {
          return Promise.resolve(_finallyRethrows(function () {
            return _catch(function () {
              return Promise.resolve(_this5.batchHelper.createMultipartRequest(request.baseURL, request.requestURLs)).then(function (responses) {
                if (responses.length) {
