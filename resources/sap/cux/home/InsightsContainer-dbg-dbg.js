 ...
 */
sap.ui.define(["./BaseContainer", "./CardsPanel", "./ErrorPanel", "./InsightsContainerGenericPlaceholder", "./TilesPanel", "./utils/Device", "./utils/InsightsUtils"], function (__BaseContainer, __CardsPanel, __ErrorPanel, ___InsightsContainerGenericPlaceholder, __TilesPanel, ___utils_Device, ___utils_InsightsUtils) {
  "use strict";
