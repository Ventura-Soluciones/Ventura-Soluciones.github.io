 ...
 */
sap.ui.define(["sap/ui/core/EventBus", "./BaseAppPanel", "./utils/Constants", "./utils/DataFormatUtils", "./utils/PageManager", "./utils/PersonalisationUtils", "./utils/UshellPersonalizer"], function (EventBus, __BaseAppPanel, ___utils_Constants, ___utils_DataFormatUtils, __PageManager, __PersonalisationUtils, __UshellPersonalizer) {
  "use strict";
  ...
  const BaseAppPersPanel = BaseAppPanel.extend("sap.cux.home.BaseAppPersPanel", {
    ...
    _getPageManagerInstance: function _getPageManagerInstance() {
      if (!this._pageManagerInstance) {
        this._pageManagerInstance = PageManager.getInstance(this._getPersContainerId(), PersonalisationUtils.getOwnerComponent(this));
      }
