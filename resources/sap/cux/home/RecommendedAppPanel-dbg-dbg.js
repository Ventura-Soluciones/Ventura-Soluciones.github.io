 ...
 */
sap.ui.define(["sap/base/Log", "sap/f/GridContainer", "sap/f/GridContainerSettings", "sap/m/Button", "sap/m/Dialog", "sap/m/IllustratedMessageSize", "sap/m/IllustratedMessageType", "sap/m/library", "sap/m/Link", "sap/m/MessageStrip", "sap/m/MessageToast", "sap/m/ScrollContainer", "sap/m/Text", "sap/m/Title", "sap/m/VBox", "sap/ui/core/Element", "sap/ui/core/EventBus", "./BaseAppPersPanel", "./MenuItem", "./utils/Constants", "./utils/FESRUtil", "./utils/HttpHelper"], function (Log, GridContainer, GridContainerSettings, Button, Dialog, IllustratedMessageSize, IllustratedMessageType, sap_m_library, Link, MessageStrip, MessageToast, ScrollContainer, Text, Title, VBox, Element, EventBus, __BaseAppPersPanel, __MenuItem, ___utils_Constants, ___utils_FESRUtil, __HttpHelper) {
  "use strict";
    ...
    loadApps: function _loadApps() {
      try {
        ...
        return Promise.resolve(_this3.appManagerInstance.getRecommendedVisualizations(true)).then(function (recommendedVisualizations) {
          ...
          const recommendedApps = _this3.generateApps(recommendedVisualizations);
          _this3.setApps(recommendedApps);
